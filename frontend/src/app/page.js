...
import { Terminal, Play, Cpu, ShieldAlert, CheckCircle, RefreshCw, LogOut, User, History, Clock } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col font-sans">
      <header className="border-b border-slate-800 bg-slate-900/50 px-6 py-4 flex items-center justify-between backdrop-blur">
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            onClick={logout}
            className="flex items-center gap-1.5 text-xs font-semibold px-3 py-1.5 bg-rose-500/10 hover:bg-rose-500/20 text-rose-400 rounded-lg border border-rose-500/20 transition-all active:scale-95"
          >
